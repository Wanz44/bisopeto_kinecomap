...
// Fixed: Explicitly import process from node:process to resolve the 'cwd' property error in TypeScript
...
export default defineConfig(({ mode }) => {
  ...
  // Fixed: use process.cwd() with explicit import to ensure Node.js types are recognized
