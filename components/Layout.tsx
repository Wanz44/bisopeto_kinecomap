    ...
    const getNavItems = () => {
        ...
        if (type === UserType.ADMIN) {
            return [
                ...
                { view: AppView.PROFILE, icon: User, label: 'Profil Admin' },
            ];
        }
        ...
        <div className="w-full h-[100dvh] flex bg-[#F5F5F5] dark:bg-[#050505] transition-colors duration-500 overflow-hidden relative font-sans">
            ...
            <aside className="hidden md:flex flex-col w-72 h-[calc(100vh-3rem)] m-6 rounded-[2.5rem] bg-white/95 dark:bg-[#111827]/95 backdrop-blur-2xl border border-gray-100 dark:border-white/5 shadow-2xl transition-all duration-300 relative z-50 shrink-0">
                <div className="p-8 flex flex-col gap-1">
                    ...
                    <div className="bg-green-50 dark:bg-green-900/10 px-3 py-1.5 rounded-xl border border-green-100 dark:border-green-900/30">
                        <p className="text-[10px] font-black text-primary-light leading-tight italic">"Agir localement, impacter durablement"</p>
                    </div>
                </div>
                ...
                <header className="h-[80px] px-6 md:px-8 flex items-center justify-between sticky top-0 z-40 shrink-0 bg-white/50 backdrop-blur-sm dark:bg-black/50">
                    ...
                    <div className="hidden md:block">
                        <h1 className="font-black text-2xl text-gray-800 dark:text-white tracking-tight flex items-center gap-3">
                            ...
                            {navItems.find(n => n.view === currentView)?.label || 'Biso Peto'}
                        </h1>
                    </div>
                    ...
                    <div className="flex items-center gap-4 ml-auto">
                        ...
                        <div className="relative">
                            <button onClick={() => setIsProfileMenuOpen(!isProfileMenuOpen)} className="pl-1 pr-1 md:pr-4 md:pl-1 py-1 rounded-full md:rounded-2xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 shadow-sm flex items-center gap-3 transition-all hover:border-primary">
